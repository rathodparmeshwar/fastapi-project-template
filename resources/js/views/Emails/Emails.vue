                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary"  @click="create_new=true" v-if="$can('notification_create')">{{ __('send_email') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(message)="row">
                                    <div class="email_table_message" v-html="row.item.message" style="width: 200px; overflow-wrap: break-word;"></div>
                                </template>
                                ...
                                <template #cell(actions)="row">
                                    <button class="btn btn-sm btn-danger" @click="deleteEmail(row.index,row.item.id)" v-if="$can('notification_delete')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                                </template>
                            </b-table>
                        </div>
                        <b-row>
