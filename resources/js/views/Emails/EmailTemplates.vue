                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary"  @click="create_new=true" v-if="$can('notification_create')">{{ __('create_email_templates') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(message)="row">
                                    <div class="" v-html="row.item.message"></div>
                                </template>
                                <template #cell(actions)="row"> 
                                    ...
                                    <button class="btn btn-sm btn-danger" @click="deleteEmailTemplate(row.index,row.item.id)" v-if="$can('notification_delete')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                                </template>
                            </b-table>
                        </div>
                        <b-row>
    ...
    data: function() {
        return {
            fields: [
                ...
                { key: 'updated_at', label: __('last_update'),  class: 'text-left',thStyle: { width: '15%' } , formatter: (value) => value ? moment(value).format('DD-MM-YYYY') : '-' },
